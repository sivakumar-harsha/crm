      ...
      if($this->session->has_userdata('logged_in'))
       {
            ...
            $lead_id=$this->input->post("lead_id");
            $h_gender=$this->input->post("h_gender");             //11.22.2024
            $Husband=$this->input->post("Husband");
            $Wife=$this->input->post("Wife");
            $Son=$this->input->post("Son");
            $Daughter=$this->input->post("Daughter");
          ...
          $date = date("Y-m-d"); 
           ...
           $dob_mother = $this->input->post("dob_mother");
            ...
            $data = array(
                ...
                $res = $this->lm->update_health_details($filtered_data,$lead_id);
                
               // echo $this->db->last_query();
                
                if( $res ){
    		        $this->audit->log('health_details', 'UPDATE', null, $_health, $filtered_data);
    		    }
