...
class Helpers
{
    ...
    public static function getFileContent($uri, $context = null, $offset = 0, $maxlen = null)
    {
        ...
        if ($is_local_path || ini_get("allow_url_fopen")) {
            ...
            if (isset($maxlen)) {
            $result = file_get_contents($uri, false, $context, $offset, $maxlen); // Replace null with false
        } else {
            $result = file_get_contents($uri, false, $context, $offset); // Replace null with false
        }
