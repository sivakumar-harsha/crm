...
<!-- Content Wrapper. Contains page content -->
            ...
            <div class="col-md-6 pull-right">
               ...
               <!-- <span class="pull-right">&nbsp;</span>-->
                ...
                <span class="pull-right">&nbsp;</span>
                    ...
                    <a href='leads' class="btn btn-warning btn-sm pull-right" id="back_btn"><i class="fa fa-backward" aria-hidden="true"></i> Back</a>
                    <span class="pull-right">&nbsp;</span>
  ...
  <div class="box hidden" id="nominee_div">
        ...
        <div class="box-body" _msthash="1196936" _msttexthash="1190501" style="text-align: left;">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <button type="button" class="btn btn-info btn-xs pull-right" id="add_nominee_btn"><i class="fa fa-save"></i>&nbsp;Save</button>
                    </div>
    ...
    <div class="box hidden sme_hidden">
        <div class="box-header with-border" style="background:#f4f4f48c;">
            <h3 class="box-title" _msthash="26273" _msttexthash="60619" style="text-align: left;font-size:14px;"><i class="fa fa-building-o" aria-hidden="true"></i> &nbsp;&nbsp; SME Details </h3>
            <div class="box-tools pull-right">
                 <button type="button" class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="" data-original-title="Collapse">
                  <i class="fa fa-minus"></i></button>
            </div>
        ...
        <div class="box-body" _msthash="1196936" _msttexthash="1190501" style="text-align: left;">
            ...
            <button class="btn btn-info btn-xs pull-right" id="add_sme_btn"><i class="fa fa-plus" aria-hidden="true"></i> Add SME Details</button>
 ...
 <!--<div  id="sme_hidden">
        <div class="box-header with-border" style="background:#f4f4f48c;">
            <h3 class="box-title" _msthash="26273" _msttexthash="60619" style="text-align: left;font-size:14px;"><i class="fa fa-car" aria-hidden="true"></i> &nbsp;&nbsp; SME Details </h3>
            <div class="box-tools pull-right">
                 <button type="button" class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="" data-original-title="Collapse">
                  <i class="fa fa-minus"></i></button>
            </div>
    ...
    <div class="box hidden" id="health_hidden">
        ...
        <div class="box-body" _msthash="1196936" _msttexthash="1190501" style="text-align: left;">
                ...
                <div class = "col-md-6">
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" id="health_insurer_name">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input type="date" class="form-control" id="health_insurer_dob">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" id="health_insurer_age">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" id="health_insurer_gender">
                            </div>
                        </div>
                    </div>
            ...
            <button class="btn btn-xs btn-info pull-right" data-toggle="modal" id='add_health_mod_btn' data-target="#add_health_model"><i class="fa fa-plus" aria-hidden="true"></i> Add Health Details</button>
            <button class="btn btn-xs btn-info pull-right hidden" id="edit_health_details"><i class="fa fa-pencil" aria-hidden="true"></i> Edit Health Details</button>
        </div>
    </div> 
                    ...
                    <label>Invoice Value (In Rupees)</label>
                        <div class="input-group">
                            <span class="input-group-addon">₹</span>
                              <input type="number" onclick="marine_calculate()" class="form-control" id="m_marine_invoice_val">
                         </div>
                </div>
...
<div id="sme_modal" class="modal fade" role="dialog">
  ...
  var childrens = 0;
                        ...
                        $.ajax({
                            ...
                            success:function(response)
                            {
                                ...
                                $("#policy_class").val(obj.class);
                                 ...
                                 {
                                        var oldUrl = $("#back_btn").attr("href");
                                        var newUrl = oldUrl.replace("leads", "leads?tab=prospect"); 
                                        $("#back_btn").attr("href", newUrl); 
                                 }
                        ...
                        $.ajax({
                                   ...
                                   success:function(response)
                                   {
                                       ...
                                       if(obj != null)
                                       {
                                           ...
                                           var content = "<a href='./datas/nominee_documents/"+obj.file+"'  target='_blank'>View Adhar File</a>";
            ...
            $.ajax({
                    ...
                    success:function(response)
                    {
                        ...
                        for(var j=0;j<obj.length;j++)
                        {
                            ...
                            {
                                var lastChar = obj[j].varient_name[obj[j].varient_name.length -1];
                                if(lastChar == ")")
                                {
                     ...
                     $.ajax({
                            ...
                            success:function(response)
                            {
                                ...
                                if(size > 0){
                                    ...
                                    {
                                        snackbar_show("Already exists the vehicle No. refer Lead ID = " + response.refer);
                                        $("#v_regn_no_1").val("");
                                        $("#v_regn_no_2").val("");
                                        $("#v_regn_no_3").val("");
                                        $("#v_regn_no_4").val("");
    ...
    $("#add_vechile_btn").click(function(){
          ...
          else if((policy_type == "1" || policy_type == "2" || policy_type == "3" || policy_type == "4") &&  vechi_varient == "")
          {
              check =1;
              Swal.fire(
                    'Select Varient ?',
          ...
          else if((policy_type == "1" || policy_type == "2" || policy_type == "3") &&  vechi_cc == "")
          {
              check =1;
              Swal.fire(
                    'Enter CC ?',
          ...
          else if(vechi_manu_year== "")
          {
              check =1;
              Swal.fire(
                    'Select manufacure Year ?',
                    '',
                    'question'
                    )
          }
          else if((policy_type == "7" || policy_type == "12" || policy_type == "13"  || policy_type == "14" || policy_type == "59" || policy_type == "60" || policy_type == "66") && passenger_carrying == "")
          {
              check =1;
              Swal.fire(
                    'Enter passenger carrying ?',
                    '',
                    'question'
                    )
          }
          
          else if((policy_type == "8" || policy_type == "9" || policy_type == "10"  || policy_type == "11" || policy_type == "15" || policy_type == "16" || policy_type == "17" || policy_type == "61") && vechi_gvw == "")
          {
              check =1;
              Swal.fire(
                    'Enter GVW ?',
          ...
          else if((business_type != "3") && (regn_no_1 == "" || regn_no_2 == "" || regn_no_3 == "" || regn_no_4 == ""))
          {
              check =1;
              Swal.fire(
                    'Enter Vechicle Register No ?',
                    '',
                    'question'
                    )
          }
      ...
      $("#h_family_members").change(function(){
           ...
           if(Daughter != '-1' && Son != "-1")
           {
                ...
                html += "<span class='input-group-addon'><i class='fa fa-minus' onclick='daughters_minus()'></i></span><input type='text' class='form-control' name='num_daughters' id='num_daughters' value='1'>";
                html += " <span class='input-group-addon'><i class='fa fa-plus' onclick='daughters()'></i></span>";
                html += " </div>";
                html += " </div>";
                ...
                html += "<div class='input-group'>";
                html += " <span class='input-group-addon'><i class='fa fa-minus' onclick='son_minus()'></i></span><input type='text' class='form-control' name='num_sons' id='num_sons' value='1'>";
                html += "<span class='input-group-addon'><i class='fa fa-plus' onclick='sons()'></i></span>";
                html += "</div>";
                html += "</div>";
       ...
       $("#edit_h_family_members").change(function(){
           ...
           if(Daughter != '-1' && Son != "-1")
           {
                ...
                html += "<label>No of Daughter's</label>";   
                html += "<div class='input-group'>";
                html += "<span class='input-group-addon'><i class='fa fa-minus' onclick='edit_daughters_minus()'></i></span><input type='text' class='form-control' name='edit_num_daughters' id='edit_num_daughters' value='1'>";
                html += " <span class='input-group-addon'><i class='fa fa-plus' onclick='edit_daughters()'></i></span>";
                html += " </div>";
                html += " </div>";
                ...
                html += "<label>No of Sons's</label>"; 
                html += "<div class='input-group'>";
                html += " <span class='input-group-addon'><i class='fa fa-minus' onclick='edit_son_minus()'></i></span><input type='text' class='form-control' name='edit_num_sons' id='edit_num_sons' value='1'>";
                html += "<span class='input-group-addon'><i class='fa fa-plus' onclick='edit_sons()'></i></span>";
                html += "</div>";
                html += "</div>";
      ...
      $("#add_health_btn").click(function(){
          ...
          formdata.append('num_sons',num_sons);
           ...
           formdata.append('daughter_dob_4',daughter_dob_4);
            ...
            else if(jQuery.inArray("You", h_family_members) !== -1 && $("#add_you_name").val() == "")
            {
                 Swal.fire(
                  'Select Insurer Name?',
                  'That thing is still around?',
            ...
            else if(jQuery.inArray("You", h_family_members) !== -1 && $("#add_dob").val() == "")
            {
                 Swal.fire(
                  'Select Insurer DOB?',
                  'That thing is still around?',
            ...
            else if(jQuery.inArray("You", h_family_members) !== -1 && $("#you_age").val() == "")
            {
                 Swal.fire(
                  'Select Insurer Age ?',
                  'That thing is still around?',
            ...
            else if(h_gender == "Male" && jQuery.inArray("Spouse", h_family_members) !== -1 && Wife_name == "")
            {
                 Swal.fire(
                  'Select Spouse Name?',
                  'That thing is still around?',
            ...
            else if(h_gender == "Male" && jQuery.inArray("Spouse", h_family_members) !== -1 && Wife_dob == "")
            {
                 Swal.fire(
                  'Select Spouse DOB?',
                  'That thing is still around?',
            ...
            else if(h_gender == "Male" && jQuery.inArray("Spouse", h_family_members) !== -1 && Wife_age == "")
            {
                 Swal.fire(
                  'Select Spouse Age?',
                  'That thing is still around?',
            ...
            else if(h_gender == "Female" && jQuery.inArray("Spouse", h_family_members) !== -1 && Husband_name == "")
            {
                 Swal.fire(
                  'Select Husband Name?',
                  'That thing is still around?',
            ...
            else if(h_gender == "Female" && jQuery.inArray("Spouse", h_family_members) !== -1 && Husband_dob == "")
            {
                 Swal.fire(
                  'Select Husband DOB?',
                  'That thing is still around?',
            ...
            else if(h_gender == "Female" && jQuery.inArray("Husband", h_family_members) !== -1 && Husband_age == "")
            {
                 Swal.fire(
                  'Select Husband Age?',
                  'That thing is still around?',
                 ...
                 success:function(response)
                 {
                    ...
                    // $("#edit_vechi_make").trigger('change');
                     ...
                     $.ajax({
                            url : "fetch_model",
                            method : "POST",
                            data :{vechile_type:obj.policy_type,vechi_make:obj.vechi_make},
                    ...
                    //$("#edit_vechi_model").trigger('change');
                     ...
                     $.ajax({
                            url : "fetch_vechile_varient",
                            method : "POST",
                            data :{vechile_type:obj.policy_type,vechi_make:obj.vechi_make,vechi_model:obj.vechi_model},
                             ...
                             var object = jQuery.parseJSON(response);
                                ...
                                if(object.length > 0)
                                {
                                    ...
                                    { 
                                        ...
                                        {
                                            str += "<option value='"+object[j].id+"' selected>"+object[j].seating_capacity+"</option>";
                                        }
                                        else
                                        {
                                             str += "<option value='"+object[j].id+"'>"+object[j].seating_capacity+"</option>";
                                        }
                                    }
    ...
    $("#update_vechile_btn").click(function(){
         ...
         if(vechile_type == "")
          ...
          else if((vechile_type == "1" || vechile_type == "2" || vechile_type == "3" || vechile_type == "4") &&  vechi_varient == "")
          {
              check =1;
              Swal.fire(
          ...
          else if((vechile_type == "1" || vechile_type == "2" || vechile_type == "3") &&  vechi_cc == "")
          {
              check =1;
              Swal.fire(
                    'Enter CC ?',
          ...
          else if((vechile_type == "7" || vechile_type == "12" || vechile_type == "13"  || vechile_type == "14" || vechile_type == "59" || vechile_type == "60") && passenger_carrying == "")
          {
              check =1;
              Swal.fire(
                    'Enter passenger carrying ?',
          ...
          else if((vechile_type == "8" || vechile_type == "9" || vechile_type == "10"  || vechile_type == "11" || vechile_type == "15" || vechile_type == "16" || vechile_type == "17" || vechile_type == "61") && vechi_gvw== "")
          {
              check =1;
              Swal.fire(
                    'Enter GVW ?',
    ...
    $("#edit_vechi_make").change(function(){
      ...
      $("#add_daughter_dob_1").change(function(){
            ...
            if(currentYear > dobYear)
            {
                ...
                {
                    var age_year = Math.floor((today-dob) / (365.25 * 24 * 60 * 60 * 1000));
                    var age = age_year * 12;
                }
                else
                {
	 ...
	 $("#add_sme_info").click(function(){
        ...
        var wc_salary_per_supervisor = $("#wc_salary_per_supervisor").val();
        ...
        var gmc_exclusion_waiver_year = $("#gmc_exclusion_waiver_year").val();
        ...
        var gmc_current_status = $("#gmc_current_status").val();
        var gmc_covid_hospitlization = $("#gmc_covid_hospitlization").val();
        ...
        else if(smepolicy == "77")
        {
            ...
            formdata.append("wc_salary_per_supervisor",wc_salary_per_supervisor);
        ...
        else if(smepolicy == "75")
        {
        	...
        	formdata.append("gmc_exclusion_waiver_year",gmc_exclusion_waiver_year);
        	formdata.append("gmc_maternity_coverage",gmc_maternity_coverage);
        	formdata.append("gmc_hospital_coverage",gmc_hospital_coverage);
        	formdata.append("gmc_icu_limits",gmc_icu_limits);
        	formdata.append("gmc_int_desease_cover",gmc_int_desease_cover);
        	formdata.append("gmc_ppn_cause",gmc_ppn_cause);
        	formdata.append("gmc_claim_sub_mission",gmc_claim_sub_mission);
        	...
        	formdata.append("gmc_current_status",gmc_current_status);
        	formdata.append("gmc_covid_hospitlization",gmc_covid_hospitlization);
        	...
        	formdata.append("gmc_ext_desease_cover",gmc_ext_desease_cover);
     ...
     $("#sme_file_add").click(function(){
           ...
           content += '              <input type = "file" class="form-control sme_file" name="files[]" required>';
           content += '          </div>';
           content += '      </div>';
           ...
           content += '              <input type = "text" class="form-control sme_file_type" name="file_name[]" required>';
           content += '          </div>';
           content += '      </div>';
           content += '  </div>';
