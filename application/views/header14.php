                  ...
                  <ul class="nav navbar-nav">
                    <li><a href="<?=base_url('home')?>">Dashboard</a></li>
                        ...
                        <li class="dropdown <?php echo $lead_tab; ?>">
                          ...
                          <ul class="dropdown-menu" role="menu">
                            <?php if($this->auth->can_access('Create Lead')):?>
                            ...
                            <?php endif;?>
                            <li class="<?php echo $temp; ?>"><a href="temp_lead"><i class="fa fa-eye" aria-hidden="true"></i> Create Lead(Min.dtls) </a></li>

                            <?php if($this->auth->can_access('List Follow Ups')):?>
                                <li class="<?php echo $follow_ups; ?>">
                                    <a href="followups">
                                        <i class="fa fa-bell" aria-hidden="true"></i> Follow Ups </a>
                                    </li>
                            <?php endif;?>
                            <?php if($this->auth->can_access('List Leads')):?>
                                <li class="<?php echo $leads; ?>">
                                    <a href="leads">
                                        <i class="fa fa-bullseye" aria-hidden="true"></i> View Leads 
                                    </a>
                                </li>
                            <?php endif;?>
                            ...
                            <?php if($this->auth->can_access('Failure Leads')):?>
                                <li class="<?php echo $failurelead; ?>">
                                    <a href="failurelead">
                                        <i class="fa fa-exclamation-triangle" aria-hidden="true"></i> Failure Leads 
                                    </a>
                                </li>
                            <?php endif;?>
                            <?php if($this->auth->can_access('SME Policy')):?>
                                <li class="<?php echo $smedetails; ?>">
                                    <a href="smedetails">
                                        <i class="fa fa-briefcase" aria-hidden="true"></i>SME Policy 
                                    </a>
                                </li>
                            <?php endif;?>
                            <?php if($this->auth->can_access('Business Calls')):?>
                                <li class="<?php echo $joinecall; ?>">
                                    <a href="jointcall">
                                        <i class="fa fa-phone" aria-hidden="true"></i> Business Calls 
                                    </a>
                                </li>
                            <?php endif;?>
                        ...
                        <li class="dropdown <?php echo $commission; ?>">
                          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <li class="<?php echo $agent_commission_closure; ?>"><a href="agent_commission_closure"><i class="fa fa-plus" aria-hidden="true"></i>Agent Commission Closure</a>
                            </li>
                            <li class="<?php echo $Mnholdrelease; ?>"><a href="policy_cancel_report"><i class="fa fa-plus" aria-hidden="true"></i>Hold / Cancel Release</a>
                            </li>
                            <li class="<?php echo $agent_vocher_generation; ?>"><a href="agent_vocher_generation"><i class="fa fa-plus" aria-hidden="true"></i>Agent Voucher Generation</a>
                            </li>
                            <li class="<?php echo $agent_voucher_payment; ?>"><a href="agent_voucher_payment"><i class="fa fa-plus" aria-hidden="true"></i>Agent Voucher Payment</a>
                             ...
                             <li class="<?php echo $pending_vouchers; ?>"><a href="agent_voucher_pending"><i class="fa fa-plus" aria-hidden="true"></i>Pending Vouchers</a>
                            </li>
                            <li class="<?php echo $agent_payment_details; ?>"><a href="agent_payment_details"><i class="fa fa-plus" aria-hidden="true"></i>Agent Payment Details</a></li>
                            
                            <li class="<?php echo $agent_advance; ?>"><a href="agent_advance"><i class="fa fa-plus" aria-hidden="true"></i>Agent Advance Payment</a>
                            </li>
                            <li class="<?php echo $company_invoice; ?>"><a href="insurance_invoice_generation"><i class="fa fa-plus" aria-hidden="true"></i>Company Invoice Generation</a>
                            </li>
                          </ul>
                        </li>
                        ...
                        <li class="dropdown <?php echo $reports; ?>">
                          ...
                          <ul class="dropdown-menu" role="menu">
                            <li class="<?php echo $agent_commission_report; ?>">
                             <a href="agent_vouchar_report"><i class="fa fa-file-o" aria-hidden="true"></i> Agent Vouchar Report</a></li>
                             
                            <li class="<?php echo $Mninvoicereport; ?>">
                             <a href="company_invoice_report"><i class="fa fa-file-o" aria-hidden="true"></i> Company Invoice Report</a></li>
                        ...
                        <li class="dropdown <?php echo $accounts; ?>">
                          ...
                          <ul class="dropdown-menu" role="menu">
                             ...
                             <a href="Accounttree"><i class="fa fa-tree" aria-hidden="true"></i>Accounts tree</a></li>
                             
                              <li class="<?php echo $commission_ac; ?>">
                              <a href="view_accounts_ledger"><i class="fa fa-money" aria-hidden="true"></i>Commission A/C</a></li>
                        ...
                        <li class="dropdwon">
                            <a href="" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li class="">
                                        <a href="roles"><i class="fa fa-tree" aria-hidden="true"></i>Role</a></li>
                                </ul>
                            </a>
                        </li>
                      ...
                      <?php if($this->session->userdata('session_role') == "user")   { ?>   
                          ...
                          <?php } ?>
                            ...
                            <?php if($this->auth->can_access('List Follow Ups')):?>
                                <li class="<?php echo $follow_ups; ?>">
                                    <a href="followups">
                                        <i class="fa fa-bell" aria-hidden="true"></i> Follow Ups 
                                    </a>
                                </li>
                            <?php endif;?>
                            <?php if($this->auth->can_access('List Leads')):?>
                            ...
                            <?php if($this->auth->can_access('List Customer')):?>
                                <li class="<?php echo $customers; ?>">
                                    <a href="customers">
                                        <i class="fa fa-users" aria-hidden="true"></i> View Customers 
                                    </a>
                                </li>
                            <?php endif;?>
                            ...
                            <?php if($this->session->userdata('session_role') == "user")   { ?>    
                                <?php if($this->auth->can_access('Renewal Leads')):?>
                                    <li class="<?php echo $renewallead; ?>">
                                        <a href="renewallead">
                                            <i class="fa fa-refresh" aria-hidden="true"></i> Renewal Leads 
                                        </a>
                                    </li>
                                <?php endif;?>
                                <?php if($this->auth->can_access('Failure Leads')):?>
                          ...
                          <ul class="dropdown-menu" role="menu">
                            ...
                            <?php if( $this->auth->can_access('Business Complete') ):?>
                                <li class="<?php echo $business_complete; ?>">
                                    <a href="business_complete">
                                        <i class="fa fa-file-text-o" aria-hidden="true"></i>Business Complete
                                    </a>
                                </li>
                            <?php endif;?>
                            <?php if( $this->auth->can_access('Active Policy') ):?>
                                <li class="<?php echo $generate_policy1; ?>">
                                    <a href="generate_policy1">
                                        <i class="fa fa-file-text-o" aria-hidden="true"></i>Active Policy 
                                    </a>
                                </li>
                            <?php endif;?>
                          </ul>
