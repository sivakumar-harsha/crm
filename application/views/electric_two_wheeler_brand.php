    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                ...
                <h4 class="modal-title text-center">Create Electric Two Wheeler Brand</h4>
            </div>
  ...
  <script>
    $(document).ready(function(){
      ...
      $("#add_btn").click(function(){
        ...
        else
        {
          ...
          $.ajax({
            url:"add_electric_two_wheeler_brand",
            data:formdata,
            processData:false,  
		    contentType:false,
		    cache:false,
      ...
      $("#edit_btn").click(function(){
        ...
        else
        {
          ...
          $.ajax({
            url:"edit_electric_two_wheeler_brand",
            data:formdata,
            processData:false,  
		    contentType:false,
		    cache:false,
    ...
    function fetch_brand()
    {
      ...
      $("#table_id").DataTable({
          ...
          "ajax":{
            'url':'fetch_electric_two_wheeler_brand',
          }
      });      
    }
    ...
    {
      $.ajax({
        url:"fetch_edit_electric_two_wheeler_brand",
        data:{id:id},
        method:"POST",
        success:function(response){
          // alert(response);
