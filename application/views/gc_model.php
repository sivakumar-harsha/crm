...
.select2-container--default .select2-selection--multiple .select2-selection__choice__remove {
    ...
    <div class="modal-dialog  modal-sm">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                ...
                <h4 class="modal-title text-center">Create Goods Carrying Vehicle Model</h4>
            </div>
  ...
  <script>
    ...
    $(document).ready(function(){
      ...
      fetch_model(s_policy_type,s_gc_brand);
      ...
      $("#select_p_type").change(function(){
         ...
         var s_gc_brand = $("#select_gc_brand").val();
         fetch_gc_brand(p_type);
         fetch_model(p_type,s_gc_brand);
      });
