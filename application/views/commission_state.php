<!-- Content Wrapper. Contains page content -->
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                ...
                <h4 class="modal-title text-center">Create Commission State</h4>
            </div>
            <div class="modal-body">
                <div class="form-group">
                  <label>State Name</label> <span id="add_name_error" style="color: red;">*</span>
  ...
  <script>
    ...
    {
      $.ajax({
        url:"fetch_edit_commission_state",
        data:{id:id},
        method:"POST",
        success:function(response){
          // alert(response);
