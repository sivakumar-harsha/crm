         ...
         <div class="nav-tabs-custom">
        	    <ul class="nav nav-tabs bg-info1">
    		        ...
    		        <li class="" id="followup_tab"><a href="#open_followup_content" data-toggle="tab" aria-expanded="false">Follow up</a></li>
    		         <li class="" id="completed_tab"><a onclick='fetch_all_completed_policy()' data-toggle="tab" aria-expanded="false">Completed</a></li>
      ...
      <div class="modal-body">
        ...
        <div class="nav-tabs-custom">
              <ul class="nav nav-tabs">
                ...
                <li class=""><a href="#tab_2" data-toggle="tab" aria-expanded="false" style="background-color:#3c8dbc;color:#fff;padding: 8px;border-color: #fff;">vehicle Informations</a></li>
...
function fetch_all_leads()
{
  ...
  $("#table_view").html(content);
   ...
   $("#table_id").DataTable({
	        ...
	        "ajax":{
	            'type': 'POST',
	            'url':'fetch_all_leads_dashboard_ai',
	            'data':{
                	id: id,
...
function fetch_all_completed_policy()
{
    var order_category = $("#order_category").val();
    var ai = $("#agent_select").val();
    
      var content = "";
      content += "<div class='table-responsive'>";
      content += "<table id='table_id' class='table table-hover table-bordered'>"; 
      content += "<thead><th>S.No</th><th>Customer</th><th>Mobile</th><th>Code</th><th>P No</th><th>Insurer</th><th>OD</th><th>TP</th><th>Net</th><th>GST</th><th>OC</th><th>AC</th><th>B Type</th><th>Class</th><th>Pol Type</th><th>S Date</th><th>E Date</th><th>Cover</th></thead>";
      content += "<tbody></tbody>";
      content += "</table>";
      content += "</div>";
      ...
      var table = $("#table_id").DataTable({
          ...
          "ajax":{
            'type': 'POST',
            'url':'fetch_all_completed_policy',
            'data':{
                	ai: ai,
                	order_category:order_category,
                },
...
function fetch_followups()
{
  ...
  $("#table_id").DataTable({
      ...
      "lengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]],
      "ajax":{
        'url':'fetch_all_follow_ups_dashboard_ai',
        'method' : "POST",
        'data':{id:id},
      }
  });      
