<!-- Content Wrapper. Contains page content -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                  <label>District Name</label> <span id="add_name_error" style="color: red;">*</span>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true" style="color:white;">×</span></button>
                <h4 class="modal-title text-center" id="edit_heading">Edit District</h4>
            </div>
            <div class="modal-body">
                <div class="form-group">
  ...
  <script>
    ...
    {
      $.ajax({
        url:"fetch_edit_district",
        data:{id:id},
        method:"POST",
        success:function(response){
          // alert(response);
          var obj = jQuery.parseJSON(response);
          $("#edit_name").val(obj.district);
          $("#edit_heading").html("Edit District");
