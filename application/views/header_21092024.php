...
<html>
  <head>
    ...
    <?php } ?>
    <link rel="stylesheet" href="<?=base_url()?>datas/css/additional_css.css">
    <script src="<?=base_url()?>datas/js/additional_js.js"></script>
...
$trialbalance_ac = "";
if($this->uri->segment(1) == "trialbalance")
{
    $accounts = "active";
    $accrpts = "active";
    $trialbalance_ac = "active";
}
...
if($this->uri->segment(1) == "cheque_details")
{
    $accounts = "active";
    $acctrans = "active";
    $cheque_details = "active";
}
...
//$acctrans = ($invoice_payment_receivable == "active") ? "active" : $companyinvoice;

if($this->uri->segment(1) == "invoice_payment_receivable")
{
    $invoice_payment_receivable = "active";
    $accounts = "active";
    $accmaster = "active";
}
...
//accounts
$agentOpening_balance = "";
$companyOpening_balance = "";
if($this->uri->segment(1) == "Opening_balance")
{
    $type = $_GET['t'];
    if($type == "agent") {
        $accounts = "active";
        $agentOpening_balance = "active";    
        $accmaster = "active";
    }
    
    if($type == "company") {
        $accounts = "active";
        $companyOpening_balance = "active";  
        $accmaster = "active";
    }
}
...
<style>
    ...
    ul.dropdown-menu {
        /* background: #077db5de;
        background-color: rgba(7, 125, 181, 1); */
    }
  ...
  <body class="hold-transition layout-top-nav <?php echo $this->session->userdata('session_company_type') == "unicorn"?"skin-green":"skin-blue" ?>">
    ...
    <div class="wrapper">
                ...
                <?php if($this->session->userdata('session_role') == "admin")   { ?>    
                  <ul class="nav navbar-nav">
                    <li><a href="<?=base_url('home')?>">Dashboard</a></li>
                        ...
                        <li class="dropdown <?php echo $accounts; ?>" style="display:none">
                          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                           <i class="fa fa-book" aria-hidden="true"></i> Accounts <span class="caret"></span>
                            ...
                            <ul class="dropdown-menu" role="menu">                            
                                ...
                                <li class="<?php echo $agentOpening_balance; ?>">
                                    <a href="Opening_balance?t=agent"><i class="fa fa-university" aria-hidden="true"></i> Agent Opening Balance</a>
                                </li>

                                <li class="<?php echo $companyOpening_balance; ?>">
                                    <a href="Opening_balance?t=company"><i class="fa fa-university" aria-hidden="true"></i> Insurance Company Opening Balance</a>
                                </li>
                                ...
                                <li class="<?php echo $daybook_ac; ?>">
                                    <a href="daybook"><i class="fa fa-money" aria-hidden="true"></i> Day Book </a>
                                </li>

                                <li class="<?php echo $trialbalance_ac; ?>">
                                    <a href="trialbalance"><i class="fa fa-money" aria-hidden="true"></i> Trial Balance </a>
                                </li>
                                ...
                                <li class="<?php echo $cheque_details; ?>">
                                    <a href="cheque_details"><i class="fa fa-list-alt" aria-hidden="true"></i>Cheque Details </a>
                                </li>
                        ...
                        <li class="dropdown <?php echo $accounts; ?>">
                          ...
                          <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <!--menu 1 start-->
                            <li class="dropdown <?php echo $accmaster; ?>"><a class="test" tabindex="-1" href="#"> <i class="fa fa-car" aria-hidden="true"></i> Master<span class="caret"></span></a>
                              <ul class="dropdown-menu dropdown-submenu">
                                                                  							
                                <li class="<?php echo $bank; ?>">
									<a href="bank"><i class="fa fa-money" aria-hidden="true"></i>Bank </a>
								</li>
        ...
        <!--                        </li>-->
                            ...
                            <!--menu 2 start-->
                            <li class="dropdown <?php echo $acctrans; ?>"><a class="test" tabindex="-1" href="#"> <i class="fa fa-book" aria-hidden="true"></i> Transaction<span class="caret"></span></a>
                              <ul class="dropdown-menu dropdown-submenu">
							  
								
								
								<li class="<?php echo $cheque_book; ?>">
									<a href="cheque_book"><i class="fa fa-money" aria-hidden="true"></i>Cheque Book </a>
								</li>
								...
								<li class="<?php echo $general_receipt; ?>">
									<a href="general_receipt"><i class="fa fa-sticky-note" aria-hidden="true"></i>General Receipt</a>
								</li>
								
								<li class="<?php echo $cheque_entry; ?>">
									<a href="cheque_entry"><i class="fa fa-list-alt" aria-hidden="true"></i>Cheque Received Entry </a>
								</li>
								
								<li class="<?php echo $main_cash_voucher; ?>">
									<a href="main_cash_voucher"><i class="fa fa-list-alt" aria-hidden="true"></i>Cash Voucher </a>
								</li>
								
								<li class="<?php echo $agent_payment_details; ?>">
									<a href="agent_payment_details"><i class="fa fa-money" aria-hidden="true"></i>Agent Payment Details</a>
								</li>
                                
                                <li class="<?php echo $agent_advance; ?>">
									<a href="agent_advance"><i class="fa fa-cc" aria-hidden="true"></i>Agent Advance Payment</a>
                                </li>
                                
                                <li class="<?php echo $agent_voucher_payment; ?>">
									<a href="agent_voucher_payment"><i class="fa fa-money" aria-hidden="true"></i>Single Agent Voucher Payment</a>
                                </li>
                                
                                <li class="<?php echo $agent_bank_transaction_entry; ?>">
									<a href="agent_bank_transact_entry"><i class="fa fa-bank" aria-hidden="true"></i>Agent Payment Entry</a>
                                </li>
                            ...
                            <!--menu 3 start-->
                            <li class="dropdown <?php echo $accrpts; ?>"><a class="test" tabindex="-1" href="#"> <i class="fa fa-motorcycle" aria-hidden="true"></i> Report<span class="caret"></span></a>
                              <ul class="dropdown-menu dropdown-submenu">
                         ...
                         <li class="dropdown <?php echo $reports; ?>">
                          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                           <i class="fa fa-file-text-o" aria-hidden="true"></i> Reports <span class="caret"></span>
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <?php print_r($this->auth->can_access('Agent Commission Report')); exit; if( $this->auth->can_access('Agent Commission Report') ):?>
                                    <li class="<?php echo $agent_commission_report; ?>">
                  ...
                  <div class="navbar-custom-menu">   
                     <ul class="nav navbar-nav">
                        <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                  <img src="<?=base_url()?>datas/images/userimg.jpg" class="user-image" alt="User Image">
                                  <span class="hidden-xs"></span>
                                </a>
                                <ul class="dropdown-menu">
                                  <!-- User image -->
                                  <li class="user-header">
                                    <img src="<?=base_url()?>datas/images/userimg.jpg" class="img-circle" alt="User Image">
                                    <p>
