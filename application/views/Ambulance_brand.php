 <!--Content Wrapper. Contains page content -->
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                ...
                <h4 class="modal-title text-center">Create Ambulance Brand</h4>
            </div>
  ...
  <script>
    ...
    function fetch_ambulance_brand()
    {
      var content = "";
    ...
    {
      $.ajax({
        url:"fetch_edit_ambulance_brand",
        data:{id:id},
        method:"POST",
        success:function(response){
          // alert(response);
