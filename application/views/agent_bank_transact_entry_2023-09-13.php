        ...
        <div class="row">
            <div class="col-md-3">
             ...
             <div class="col-md-3">
                 ...
                 <a href="<?=base_url('/datas/bank_agent_commission_amount/bank_agent_commission_amount_sample_excel.xlsx')?>" class="btn btn-primary btn-sm pull-right" >Sapmle download</a>
