      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="row">
              ...
              <div class="col-md-2">
                  <input class="form-check-input check" type="checkbox" value="1" id="email_add">&nbsp;Add
              </div>
              
              <div class="col-md-2">
                  <input class="form-check-input check" type="checkbox" value="1" id="email_edit">&nbsp;Edit
              </div>
              
              <div class="col-md-2">
                  <input class="form-check-input check" type="checkbox" value="1" id="email_view">&nbsp;View
              </div>
          ...
          <div class="row">
              ...
              <div class="col-md-3">
                  <input class="form-check-input check" type="checkbox" value="1" id="policy_add">&nbsp;Add
              </div>
              
              <div class="col-md-3">
                  <input class="form-check-input check" type="checkbox" value="1" id="policy_view">&nbsp;View
              </div>
  ...
  var role = 'user';
     ...
     $(document).ready(function(){
         ...
         $.ajax({
                    ...
                    method : "POST",
                    data : {user_id:user_id,pos_add:pos_add,pos_edit:pos_edit,pos_view:pos_view,agent_add:agent_add,agent_edit:agent_edit,agent_view:agent_view,masters_add:masters_add,masters_edit:masters_edit,masters_view:masters_view,email_add:email_add,email_edit:email_edit,email_view:email_view,policy_add:policy_add,policy_view:policy_view,renewals_view:renewals_view,unicon_access:unicon_access},
                    beforeSend:function(){
