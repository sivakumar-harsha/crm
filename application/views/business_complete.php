...
.modal-body {
  ...
  <script>
    ...
    function fetch_business_complete()
    {
      ...
      content += "<thead><th>S.No</th><th>Customer</th><th>Mobile</th><th>Class</th><th>Policy_type</th><th>Business_Type</th><th>Policy_no</th><th>OD</th><th>TP</th><th>Net</th><th>GST</th><th>Policy_issue</th><th>Partner_name</th><th>FOE</th><th>AI</th><th>Action_record</th></thead>";
      content += "<tbody></tbody>";
      content += "</table>";
      content += "</div>";
