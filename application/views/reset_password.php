...
<html>
  ...
  <style type="text/css">
    .login-page
    {
      background-image: url('datas/images/background-img.jpg');
    ...
    <div class="login-box">
      ...
      <div class="login-box-body">
        <p class="login-box-msg">
            ...
            <span style="color: red;"><?php echo "<br>".$this->session->flashdata('error_msg'); ?></span>
        </p>
        <form action="reset_password_submit" method="post">
          <div class="form-group has-feedback">
            <input type="password" class="form-control" name="new_psw" minlength="8" placeholder="New Password">
            <span class="fa fa-lock form-control-feedback"></span>
          </div>
          <div class="form-group has-feedback">
            <input type="password" class="form-control" name="confirm_psw" minlength="8" placeholder="Confirm Password">
            <span class="fa fa-lock form-control-feedback"></span>
          </div>
          <div class="row">
            <div class="col-xs-8">
