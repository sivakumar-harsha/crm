 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1 style="font-size: 17px;">
          Invoice Generation
        <button type="button" class="btn btn-info btn-sm pull-right" style='margin-top: -8px;' id="invoice_btn" onclick="invoice()"><i class="fa fa-file"></i>&nbsp;Get Invoice</button>&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <script>
      ...
      function invoice()
      {
          window.open("get_invoice?ins_company="+ins_company+"&&select_class="+select_class+"&&select_c_type="+select_c_type+"&&from_date="+from_date+"&&to_date="+to_date, "_blank");
      }
  </script>