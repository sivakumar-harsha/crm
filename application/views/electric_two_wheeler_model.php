    ...
    <div class="modal-dialog  modal-sm">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                ...
                <h4 class="modal-title text-center">Create E-Two Wheeler Model</h4>
            </div>
  ...
  <script>
    $(document).ready(function(){
      ...
      $("#add_btn").click(function(){
        ...
        else
        {
          ...
          $.ajax({
            url:"add_electric_two_wheeler_model",
            data:{name:name,
                brand:brand,
                name1:name1,
            },
      ...
      $("#edit_btn").click(function(){
        ...
        {
          $.ajax({
            url:"edit_electric_two_wheeler_model",
    ...
    function fetch_model()
    {
      ...
      $("#table_id").DataTable({
          ...
          "ajax":{
            'url':'fetch_electric_two_wheeler_model',
          }
      });      
    }
    ...
    {
      $.ajax({
        url:"fetch_edit_electric_two_wheeler_model",
        data:{id:id},
        method:"POST",
        success:function(response){
          // alert(response);
