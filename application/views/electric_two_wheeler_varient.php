    ...
    <div class="modal-dialog  modal-sm">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                ...
                <h4 class="modal-title text-center">Create Electric Two Wheeler Varient</h4>
            </div>
  ...
  <script>
    $(document).ready(function(){
      ...
      $('#add_brand').change(function(){
          ...
          $.ajax({
            url:"get_electric_two_wheeler_brand_logo",
            data:{brand:brand},
            method:"POST",
          ...
          $.ajax({
            url:"get_electric_two_wheeler_model_list",
            data:{brand:brand},
            method:"POST",
            success:function(response){
      ...
      $("#add_btn").click(function(){
        ...
        else
        {
          ...
          $.ajax({
            url:"add_electric_two_wheeler_varient",
            data:{name:name,
                brand:brand,
                name1:name1,
                model:model,
      ...
      $("#edit_btn").click(function(){
        ...
        {
          $.ajax({
            url:"edit_electric_two_wheeler_varient",
            data:{name:name,
                id:id,
                brand:brand,
                model:model,
    ...
    function fetch_varient()
    {
      ...
      $("#table_id").DataTable({
          ...
          "ajax":{
            'url':'fetch_electric_two_wheeler_varient',
          }
      });      
    }
    ...
    {
      $.ajax({
        url:"fetch_edit_electric_two_wheeler_varient",
        data:{id:id},
        method:"POST",
        success:function(response){
          // alert(response);
