  ...
  public function check_this_lead_id_already_exits($id)
  {
  	 ...
  	 public function fetch_all_leads($lead_type,$classification,$category,$bulk_status,$order_category,$search,$search_vechicle)
    {
       ...
       if($this->session->userdata('session_role') == "user") {
        ...
        // $query = $this->db->get_compiled_select("list_of_leads");
        // log_message('error', 'Fetch Leads Query: ' . $query);
...
// exit();
        ...
        // $result = $this->db->get("list_of_leads")->result();
    
        // 🔍 Debugging: Log the result count
        // log_message('error', 'Fetched Leads Count: ' . count($result));
